...
public class CustomerDto {
    ...
    public CustomerDto(Long customerId, String username, String firstName, String lastName,
        ...
        this.customerId = customerId; this.username = username; this.firstName = firstName;
        this.lastName = lastName; this.fullName = firstName + " " + lastName;
        this.email = email; this.contactNo = contactNo; this.status = status; this.createdDate = createdDate;
    }
