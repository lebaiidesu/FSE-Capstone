package com.bank.ledger.auth.config;
...
@EnableJpaRepositories(
        basePackages = "com.bank.ledger.auth.repository",
...
public class OracleDataSourceConfig {
    ...
    public LocalContainerEntityManagerFactoryBean oracleEntityManagerFactory(
        ...
        return builder
                ...
                .packages("com.bank.ledger.auth.model")
                .persistenceUnit("authUnit")
